...
> **这是「板子联网跑通」的第一份证据 —— 注意是冷启动之后拍的,
> 所以它同时证明了配置能自动恢复,不只是"这一次手工设好了"。**
